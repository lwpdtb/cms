...
if($dopost=='saveedit')
{
    ...
    if($id!=1){
        $query = "UPDATE `#@__admin` SET uname='$uname',usertype='$usertype',tname='$tname',email='$email',mobile='$mobile',typeid='$typeid' $pwd WHERE id='$id'";
    }else{
        $query = "UPDATE `#@__admin` SET uname='$uname',tname='$tname',email='$email',mobile='$mobile',typeid='$typeid' $pwd WHERE id='$id'";
    }
