...
class TypeUnit
{
    ...
    function ListAllType($channel=0,$nowdir=0)
    {
        ...
        while($row = $this->dsql->GetObject(0))
        {
            ...
            echo "<table width='100%' style='margin-top: 15px;' cellspacing='0' cellpadding='2'>\r\n";
            //普通列表
            if($ispart==0)
            {
                echo "  <tr>\r\n";
                echo "  <td style='border-radius: 8px 0 0 8px;background: white;border-top: 1px solid rgb(".$x.",".$y.",".$z.");' width='2%' class='bline'><img style='cursor:pointer' id='img".$id."' onClick=\"LoadSuns('suns".$id."',$id);\" src='images/dedeexplode.gif' width='11' height='11'></td>\r\n";
                echo "  <td style='border-radius: 0px 8px 8px 0px;background: white;border-top: 1px solid rgb(".$x.",".$y.",".$z.");' class='bline'><table width='98%' border='0' cellspacing='0' cellpadding='0'><tr><td width='50%'><input class='np' type='checkbox' name='tids[]' value='{$id}'><a href='catalog_do.php?cid=".$id."&dopost=listArchives' oncontextmenu=\"CommonMenu(event,this,$id,'".urlencode($typeName)."')\">{$nss}".$typeName."[ID:".$id."]</a>(文档：".$this->GetTotalArc($id).")  ";
            ...
            else if($ispart==1)
            {
                echo "  <tr >\r\n";
                echo "  <td style='border-radius: 8px 0 0 8px;background: white;border-top: 1px solid rgb(".$x.",".$y.",".$z.");'  width='2%' class='bline'><img style='cursor:pointer' id='img".$id."' onClick=\"LoadSuns('suns".$id."',$id);\" src='images/dedeexplode.gif' width='11' height='11'></td>\r\n";
                echo "  <td style='border-radius: 0px 8px 8px 0px;background: white;border-top: 1px solid rgb(".$x.",".$y.",".$z.");' class='bline'><table width='98%' border='0' cellspacing='0' cellpadding='0'><tr><td width='50%'><input class='np' type='checkbox' name='tids[]' value='{$id}'><a href='catalog_do.php?cid=".$id."&dopost=listArchives' oncontextmenu=\"CommonMenuPart(event,this,$id,'".urlencode($typeName)."')\">{$nss}".$typeName."[ID:".$id."]</a>  ";
                echo "    </td><td align='right'>";
                echo "<a href='catalog_add.php?id={$id}'>增加子类</a>";
                echo "|<a href='catalog_edit.php?id={$id}'>更改</a>";
                echo "|<a href='catalog_do.php?dopost=moveCatalog&typeid={$id}'>移动</a>";
            ...
            else if($ispart==2)
            {
                ...
                echo "  <td class='bline2'><table width='98%' border='0' cellspacing='0' cellpadding='0'><tr><td width='50%'><input class='np' type='checkbox' name='tids[]' value='{$id}'><a href='catalog_edit.php?id=".$id."' oncontextmenu=\"SingleMenu(event,this,$id,'".urlencode($typeName)."')\">{$nss}".$typeName."[ID:".$id."]</a>  ";
                echo "    </td><td align='right'>";
                echo "<a href='catalog_edit.php?id={$id}'>更改</a>";
                echo "|<a href='catalog_do.php?dopost=moveCatalog&typeid={$id}'>移动</a>";
                echo "|<a href='catalog_del.php?id={$id}&typeoldname=".urlencode($typeName)."'>删除</a>";
        ...
        if($this->dsql->GetTotalRow($fid)>0)
        {
            while($row = $this->dsql->GetObject($fid))
            {
                ...
                if($ispart==0)
                {
                    ...
                    echo "<input class='np' type='checkbox' name='tids[]' value='{$id}'>$step <img style='cursor:pointer' id='img".$id."' onClick=\"LoadSuns('suns".$id."',$id);\" src='images/dedeexplode.gif' width='11' height='11'> <a href='catalog_do.php?cid=".$id."&dopost=listArchives'>{$nss}".$typeName."[ID:".$id."]</a>(文档：".$this->GetTotalArc($id).")  ";
                    echo "</td><td align='right'>";
                    echo "|<a href='catalog_add.php?id={$id}'>增加子类</a>";
                    echo "|<a href='catalog_edit.php?id={$id}'>更改</a>";
                    echo "|<a href='catalog_do.php?dopost=moveCatalog&typeid={$id}'>移动</a>";
                ...
                else if($ispart==1)
                {
                    ...
                    echo "<input class='np' type='checkbox' name='tids[]' value='{$id}'>$step <img style='cursor:pointer' id='img".$id."' onClick=\"LoadSuns('suns".$id."',$id);\" src='images/dedeexplode.gif' width='11' height='11'> <a href='catalog_do.php?cid=".$id."&dopost=listArchives'>{$nss}".$typeName."[ID:".$id."]</a>  ";
                    echo "</td><td align='right'>";
                    echo "|<a href='catalog_add.php?id={$id}'>增加子类</a>";
                    echo "|<a href='catalog_edit.php?id={$id}'>更改</a>";
                    echo "|<a href='catalog_do.php?dopost=moveCatalog&typeid={$id}'>移动</a>";
