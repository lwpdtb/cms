...
<style>
.linerow {border-bottom: 1px solid #CBD8AC;width:200px;margin: 20px}
...
$filetmp = $filearr[1];
while($excid < $id){
	$filearr[$excid] = $filearr[$excid + 1];
	$excid ++;
}
$filearr[$id-1] = $filetmp;
$id--;
//用于排序的代码2017/3/3
while($id > 0) {
	//while($file = $dh->read()){
   ...
   <a href=\"#\" onClick=\"ReturnImg('$reurl');\"><img src='$reurl' width='200' height='200' border='0' align=absmiddle></a>
